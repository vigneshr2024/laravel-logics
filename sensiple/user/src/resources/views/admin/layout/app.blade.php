...
<head>
    ...
    <title>Admin Dashboard - CloudSense </title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('sensiple/assets/img/favicon.ico') }}" rel="icon">
    <link href="{{ asset('sensiple/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ asset('sensiple/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('sensiple/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('sensiple/assets/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
    <link href="{{ asset('sensiple/assets/vendor/quill/quill.snow.css') }}" rel="stylesheet">
    <link href="{{ asset('sensiple/assets/vendor/quill/quill.bubble.css') }}" rel="stylesheet">
    <link href="{{ asset('sensiple/assets/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
    <link href="{{ asset('sensiple/assets/vendor/simple-datatables/style.css') }}" rel="stylesheet">

    <link href="{{ asset('sensiple/assets/css/style.css') }}" rel="stylesheet">
    @yield('page-css')
</head>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/user/admin/dashboard" class="logo d-flex align-items-center">
                <img src="{{ asset('sensiple/assets/img/logo.ico') }}" alt="">
                <span class="d-none d-lg-block">CloudSense</span>
            </a>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>CloudSense</span></strong>. All Rights Reserved
        </div>
    </footer><!-- End Footer -->
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('sensiple/assets/vendor/apexcharts/apexcharts.min.js') }}"></script>
    <script src="{{ asset('sensiple/assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('sensiple/assets/vendor/chart.js/chart.umd.js') }}"></script>
    <script src="{{ asset('sensiple/assets/vendor/echarts/echarts.min.js') }}"></script>
    <script src="{{ asset('sensiple/assets/vendor/quill/quill.js') }}"></script>
    <script src="{{ asset('sensiple/assets/vendor/simple-datatables/simple-datatables.js') }}"></script>
    <script src="{{ asset('sensiple/assets/vendor/tinymce/tinymce.min.js') }}"></script>
    <script src="{{ asset('sensiple/assets/vendor/php-email-form/validate.js') }}"></script>

    <!-- Template Main JS File -->
    <script src="{{ asset('sensiple/assets/js/main.js') }}"></script>
    @yield('page-script')
