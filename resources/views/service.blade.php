...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="banner-wrapper">
                        <div class="banner-content">
                            ...
                            <h1>RAMP: Accelerate Your Digital Transformation </h1>
                        </div>
    ...
    <div class="service-details-page pt-120 mb-120" id="service-details-section">
        <div class="container">
                ...
                <div class="row g-lg-4 gy-5 align-items-center">
                    <div class="col-lg-6 order-lg-1 order-2 wow animate fadeInLeft" data-wow-delay="200ms"
                        ...
                        <div class="service-details-top-content">
                            <h2>What is RAMP? </h2>
                            <p>RAMP is designed to modernize your legacy applications to build new native applications with
                                the help of robust infrastructure of Google Cloud. Here’s a breakdown of RAMP’s components
                                and how they help you in enhancing your digital transformation journey: </p>
                            {{-- <ul class="key-features">
                                <li>
                                    ...
                                    Compute Engine: Unmatched Flexibility
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                        viewBox="0 0 15 15">
                                    ...
                                    App Engine: Scalable Web Applications
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                        viewBox="0 0 15 15">
                                    ...
                                    Kubernetes Engine: Robust Orchestration
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                        viewBox="0 0 15 15">
                            ...
                            <ul class="">
                                <li>
                                    ...
                                    <strong> Compute Engine: Unmatched Flexibility </strong>
                                    Run custom workloads with unparallel flexibility. Compute Engine offers infrastructure
                                    to handle your most demanding applications.
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                        viewBox="0 0 15 15">
                                    ...
                                    <strong> Engine: Scalable Web Applications </strong>
                                    App Engine manages your application infrastructure, letting you focus on your code.
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                        viewBox="0 0 15 15">
                                    ...
                                    <strong> Kubernetes Engine: Robust Orchestration </strong>
                                    Achieve seamless orchestration across containerized environments. Kubernetes Engine
                                    provides powerful platform for managing your containers at scale.
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                        viewBox="0 0 15 15">
                                    ...
                                    <strong> Cloud Functions: Event-Driven Serverless Computing </strong>
                                    Enable serverless computing with Cloud Functions and create event-driven applications
                                    that scale automatically based on the requirement.
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row g-lg-4 gy-5 align-items-xl-center">
                    <div class="col-lg-6">
                        <div class="service-details-faq-img">
                            <img src="assets/img/innerpage/service-details-faq-img.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <div class="accordion" id="accordionTravel">
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            Run custom workloads with unparallel flexibility. Compute Engine offers
                                            infrastructure to handle your most demanding applications.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            App Engine manages your application infrastructure, letting you focus on your
                                            code.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Achieve seamless orchestration across containerized environments. Kubernetes
                                            Engine provides powerful platform for managing your containers at scale.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseFour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Enable serverless computing with Cloud Functions and create event-driven
                                            applications that scale automatically based on the requirement.
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="service-details-faq-area wow animate pt-80 mb-80" data-wow-delay="400ms"
                data-wow-duration="1500ms">
                            ...
                            <div class="accordion" id="accordionTravel">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#faqcollapseOne" aria-expanded="true"
                                            aria-controls="faqcollapseOne">
                                            01. Automated Assessment and Planning
                                        </button>
                                    </h2>
                                    <div id="faqcollapseOne" class="accordion-collapse collapse show"
                                        aria-labelledby="faqheadingOne" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            RAMP automates the assessment of the current infrastructure, reducing manual
                                            efforts and associated risks through insight into compatibility and
                                            dependencies.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingTwo">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            02. Efficient Migration Execution
                                        </button>
                                    </h2>
                                    <div id="faqcollapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingTwo" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            It automates workload migration for speed, reduces downtime with predefined
                                            workflows.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseThree" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingThree" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            RAMP ensures data integrity and compliance through inbuilt checks and encryption
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseFour" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingFour" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            It optimizes workloads on Google Cloud for performance using cloud-native
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseFive" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            RAMP provides cost estimation and management tools for expense control and
                                            optimization of spending on the cloud.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingSix">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#faqcollapseSix" aria-expanded="true"
                                            aria-controls="faqcollapseSix">
                                            06. Post-Migration Support
                                        </button>
                                    </h2>
                                    <div id="faqcollapseSix" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingSix" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            It supports and provides tools for monitoring and workload optimization after
                                            migration.
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6">
                    <ul class="service-feature-list">
                        <li class="single-feature wow animate fadeInDown" data-wow-delay="200ms"
                            ...
                            <div class="content">
                                <h5>Cloud Adoption for Enterprises</h5>
                                <p>RAMP provides an easier, more assured way to migrate on-premises infrastructure to Google
                                    Cloud, minimizing downtime and ensuring a secure transition.</p>
                            </div>
                        </li>
                        <li class="single-feature wow animate fadeInDown" data-wow-delay="400ms"
                            ...
                            <div class="content">
                                ...
                                <p>It empowers modernization of legacy applications to move them to the Google Cloud and
                                    take benefit from cloud-native elements.</p>
                            </div>
                        </li>
                        <li class="single-feature wow animate fadeInDown" data-wow-delay="600ms"
                            ...
                            <div class="content">
                                ...
                                <p>RAMP allows setting up scalable disaster recovery solutions on Google Cloud with minimal
                                    manual effort.</p>
                            </div>
                        </li>
                        <li class="single-feature wow animate fadeInDown" data-wow-delay="800ms"
                            ...
                            <div class="content">
                                ...
                                <p>It simplifies migration of data and applications from physical data centers to Google
                                    Cloud, hence reducing infrastructure costs.</p>
                            </div>
                        </li>
                        <li class="single-feature wow animate fadeInDown" data-wow-delay="400ms"
                            data-wow-duration="1500ms">
