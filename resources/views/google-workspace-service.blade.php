                ...
                <div class="col-lg-12">
                    <div class="banner-wrapper">
                        <div class="banner-content">
                            ...
                            <h1>Google Workspace: Enhance Your Team’s Productivity </h1>
                        </div>
        ...
        <div class="container">
                            ...
                            <div class="accordion" id="accordionTravel">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#componentfaqcollapseOne" aria-expanded="true"
                                            aria-controls="faqcollapseOne">
                                            Gmail
                                        </button>
                                    </h2>
                                    <div id="componentfaqcollapseOne" class="accordion-collapse collapse show"
                                        aria-labelledby="faqheadingOne" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Smart, highly intuitive email management software with features such as smart
                                            composing, priority inbox, and high security.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingTwo">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#componentfaqcollapseTwo" aria-expanded="false"
                                            aria-controls="faqcollapseTwo">
                                            Google Drive
                                        </button>
                                    </h2>
                                    <div id="componentfaqcollapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingTwo" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Secure cloud storage for all documents and files, made accessible and easy to
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingThree">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#componentfaqcollapseThree" aria-expanded="false"
                                            aria-controls="faqcollapseThree">
                                            Google Docs, Google Sheets, Google Slides
                                        </button>
                                    </h2>
                                    <div id="componentfaqcollapseThree" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingThree" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Real-time collaborative office suite to edit documents, spreadsheets, and
                                            presentations with real-time software.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingFour">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#componentfaqcollapseFour" aria-expanded="false"
                                            aria-controls="faqcollapseFour">
                                            Google Meet
                                        </button>
                                    </h2>
                                    <div id="componentfaqcollapseFour" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingFour" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Conduct crystal-clear video meetings, share screens, and record sessions.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingFive">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#componentfaqcollapseFive" aria-expanded="false"
                                            aria-controls="faqcollapseFive">
                                            Google Calendar
                                        </button>
                                    </h2>
                                    <div id="componentfaqcollapseFive" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingFive" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Easily organize your time with scheduling and management tools that help you
                                            manage multiple things in a single view.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingSix">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#componentfaqcollapseSix"
                                            aria-expanded="false" aria-controls="faqcollapseSix">
                                            Google Chat
                                        </button>
                                    </h2>
                                    <div id="componentfaqcollapseSix" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingSix" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Real-time conversations and communications with your team.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingSeven">
                                        <button class="accordion-button" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#componentfaqcollapseSeven"
                                            aria-expanded="false" aria-controls="faqcollapseSeven">
                                            Google Keep
                                        </button>
                                    </h2>
                                    <div id="componentfaqcollapseSeven" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingSeven" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Quickly capture ideas, alongside creating to-do lists to stay organized.
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="service-details-top-area mb-80">
                <div class="row g-lg-4 gy-5 align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-2 order-1 wow animate fadeInLeft" data-wow-delay="200ms"
                        data-wow-duration="1500ms">
                        <div class="faq-content">
                            <div class="accordion" id="accordionTravel">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#benefitfaqcollapseOne" aria-expanded="true"
                                            aria-controls="faqcollapseOne">
                                            Better Collaboration
                                        </button>
                                    </h2>
                                    <div id="benefitfaqcollapseOne" class="accordion-collapse collapse show"
                                        aria-labelledby="faqheadingOne" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Real-time editing on reports, spreadsheets, and presentations enhance teamwork.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingTwo">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#benefitfaqcollapseTwo"
                                            aria-expanded="false" aria-controls="faqcollapseTwo">
                                            Increased Productivity
                                        </button>
                                    </h2>
                                    <div id="benefitfaqcollapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingTwo" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Access all your files and applications wherever you are and whatever device you
                                            are using by connecting to the internet.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingThree">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#benefitfaqcollapseThree"
                                            aria-expanded="false" aria-controls="faqcollapseThree">
                                            Improved Communication
                                        </button>
                                    </h2>
                                    <div id="benefitfaqcollapseThree" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingThree" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Efficient email communication, video calling, and real-time chat capabilities.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingFour">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#benefitfaqcollapseFour"
                                            aria-expanded="false" aria-controls="faqcollapseFour">
                                            Safe and Secure
                                        </button>
                                    </h2>
                                    <div id="benefitfaqcollapseFour" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingFour" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faqheadingFive">
                                        <button class="accordion-button" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#benefitfaqcollapseFive"
                                            aria-expanded="false" aria-controls="faqcollapseFive">
                                            Cost-Effective
                                        </button>
                                    </h2>
                                    <div id="benefitfaqcollapseFive" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingFive" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Offer's agile plans for small startups and large enterprises.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion" id="accordionTravel">
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseOne" class="accordion-collapse collapse show"
                                        aria-labelledby="faqheadingOne" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Utilize AI-powered writing assistance in Gmail to compose emails faster.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingTwo" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Dictate emails, documents, and slides with ease.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseThree" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingThree" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Access relevant information in Google Workspace apps.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseFour" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingFour" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Easily bring people, files, and meetings with a single click.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="faqcollapseFive" class="accordion-collapse collapse"
                                        aria-labelledby="faqheadingFive" data-bs-parent="#accordionTravel">
                                        <div class="accordion-body">
                                            Extend Google Docs functionality with integrations from third-party apps.
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title5 mb-70 wow animate fadeInLeft" data-wow-delay="200ms"
                        ...
                        <p>Feel free adapt this based on the specific managed services, features, and unique selling points
                            your IT service company provides.</p> --}}
                    </div>
                </div>
                <div class="col-lg-6">
                    <ul class="service-feature-list">
                        <li class="single-feature wow animate fadeInDown" data-wow-delay="200ms"
                            data-wow-duration="1500ms">
                            <div class="icon">
                        ...
                        <li class="single-feature wow animate fadeInDown" data-wow-delay="400ms"
                            ...
                            <div class="content">
                                <h5>Enabling Remote Work</h5>
                                <p>No location can limit the access and editing of files, hence productivity will not be
                                    hampered.</p>
                            </div>
                        </li>
                        <li class="single-feature wow animate fadeInDown" data-wow-delay="600ms"
                            data-wow-duration="1500ms">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                    viewBox="0 0 32 32">
                            ...
                            <div class="content">
                                ...
                                <p>Keep in touch with your team members through email, chat, and video conferencing for
                                    great communication.</p>
                            </div>
                        </li>
                        <li class="single-feature wow animate fadeInDown" data-wow-delay="800ms"
                            data-wow-duration="1500ms">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                    viewBox="0 0 32 32">
