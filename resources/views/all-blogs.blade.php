...
@section('content')
    ...
    <div class="blog-grid-sidebar-section scroll-margin pt-120 mb-120" id="blog-grid">
        <div class="container">
            <div class="row g-lg-4 gy-5">
                <div class="col-lg-8">
                    <div class="row g-4 mb-50">
                        @if (count($blogs) > 0)
                            @foreach ($blogs as $blog)
                                <div class="col-md-6 wow animate fadeInDown" data-wow-delay="200ms"
                                    data-wow-duration="1500ms">
                                    <div class="blog-card style-2">
                                        <div class="blog-card-img-wrap">
                                            <a href="/blogs/{{ $blog->post_url }}" class="card-img">
                                                <img src="{{ asset($blog->thumbnail_image) }}" alt="">
                                            </a>
                                            <a href="/blogs" class="date">
                                        ...
                                        <div class="card-content">
                                                ...
                                                @if (isset($blog->categories) && count($blog->categories) > 0)
                                                    <ul class="category">
                                                        @foreach ($blog->categories as $category)
                                                            <li><a href="/blogs">{{ $category->name }}</a></li>
                                                        @endforeach
                                                    </ul>
                                                @endif
                                            ...
                                            <h4><a href="/blogs/{{ $blog->post_url }}">{{ $blog->title }}</a></h4>
                                            <a href="/blogs/{{ $blog->post_url }}" class="read-more-btn">Read More
                    ...
                    <div class="row">
                        <div class="col-lg-12 d-flex justify-content-center wow animate fadeInUp" data-wow-delay="400ms"
                            data-wow-duration="1500ms">
                ...
                <div class="col-lg-4 wow animate fadeInRight" data-wow-delay="400ms" data-wow-duration="1500ms">
