...
<head>
    ...
    <!-- Title -->
    <title>CloudSens</title>
    <link rel="icon" href="{{ asset('sensiple/assets/img/clousens-favicon.png') }}" type="image/gif"
        sizes="20x20">
...
<body>
            ...
            <div class="container d-flex align-items-center justify-content-between">
                <div class="sidebar-menu-logo">
                    <a href="/" class="logo-dark"><img alt="image" class="img-fluid"
                            src="{{ asset('sensiple/assets/img/cloudsens-logo.png') }}"></a>
                    <a href="/" class="logo-light"><img alt="image" class="img-fluid"
                            src="{{ asset('sensiple/assets/img/cloudsens-logo.png') }}"></a>
                </div>
                        ...
                        <ul class="main-menu">
                            <li>
                                ...
                                <ul class="submenu-list">
                                    ...
                                    <li>
                                        <a href="data-ai-service">Data & AI
                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"
                                                viewBox="0 0 10 10">
                                                <path
                                                    d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                    ...
                                    <li>
                                        <a href="contact-center-service">Contact Center AI
                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"
                                                viewBox="0 0 10 10">
                                                <path
                                                    d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                    ...
                                    <li>
                                        <a href="google-workspace-service">Google Workspace
                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"
                                                viewBox="0 0 10 10">
                                                <path
                                                    d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                    ...
                    <div class="sidebar-contact">
                        ...
                        <!-- <div class="social-link-area">
                            ...
                            <ul class="social-area">
                                ...
                                <li><a href="https://www.facebook.com/"><i class="bi bi-facebook"></i> Facebook</a>
                                </li>
                            </ul>
                        </div> -->
                    </div>
    ...
    <header class="header-area style-1" id="header">
        <div class="container d-flex flex-nowrap align-items-center justify-content-between">
            ...
            <div class="main-menu d-lg-flex d-none">
                <ul class="menu-list">
                    ...
                    <li>
                        <a href="/case-study" class="drop-down">Case Study</a><i
                            class="bi bi-plus dropdown-icon"></i>

                    </li>
                    <li>
                        <a href="/blogs" class="drop-down">Blog</a><i class="bi bi-plus dropdown-icon"></i>

                    </li>
                    <li>
                        <a href="/contact" class="drop-down">Contact</a>
                    </li>
            ...
            <div class="nav-right d-flex jsutify-content-end align-items-center">
                <div class="right-sidebar-and-hotline-area">
                    ...
                    <div class="sidebar-btn rounded-3">
    ...
    <footer class="footer-section">
        <div class="container" id="footer-id">
                ...
                <div class="row align-items-center justify-content-center">
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="menu-container">
                                <ul class="widget-list">
                                    <li><a href="/ramp-service">RaMP</a></li>
                                    <li><a href="/data-ai-service">Data and AI</a></li>
                                    <li><a href="/contact-center-service">Contact Center</a></li>
                                    <li><a href="/google-workspace-service">Google Workspace</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="footer-logo-area">
                            <div class="logo-bg">
                                <img src="{{ asset('assets/img/home1/footer-logo-bg.png') }}" alt=""
                                    class="light">
                                <img src="{{ asset('assets/img/home1/footer-logo-bg-dark.png') }}" alt=""
                                    class="dark">
                            </div>
                            <div class="logo">
                                <img src="{{ asset('sensiple/assets/img/cloudsens-logo.png') }}" alt=""
                                    class="light">
                                <img src="{{ asset('sensiple/assets/img/cloudsens-logo.png') }}" alt=""
                                    class="dark">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex justify-content-lg-end justify-content-sm-end">
                        <div class="footer-widget">
                            <div class="widget-title">
                                <h4>About us</h4>
                            </div>
                    ...
                    {{-- <div
                     ...
                     d-flex justify-content-lg-end justify-content-sm-end">
                        <div class="footer-widget">
                            ...
                            <div class="content">
                                <p>Welcome to Zenfy, where innovation meets our passion in a journey that started with a
                                    simple idea and a shared dream.</p>
                            </div>
                            <ul class="rating-area">
                                <li>
                                    <a href="https://clutch.co/" class="single-rating">
                                        <div class="review">
                                            <span>Review On</span>
                                            <img src="{{ asset('assets/img/home1/icon/clutch-logo.svg')}}" alt=""
                    class="logo-dark">
                    <img src="{{ asset('assets/img/home1/icon/clutch-logo-white.svg')}}" alt=""
                        class="logo-light">
                </div>
                <div class="rating">
                    <ul class="star">
            ...
            {{-- <div class=" contact-area">
                ...
                <div class="hotline-area">
                    ...
                    <div class="content">
                        <span>Address</span>
                        <h6><a
                                href="https://www.google.com/maps/place/Egens+Lab/@23.8340712,90.3631117,17z/data=!3m1!4b1!4m6!3m5!1s0x3755c14c8682a473:0xa6c74743d52adb88!8m2!3d23.8340663!4d90.3656866!16s%2Fg%2F11rs9vlwsk?entry=ttu">Chennai,
                                India</a></h6>
                    </div>
                </div>
                <div class="hotline-area">
                    ...
                    <div class="content">
                        <span>Say Hello</span>
                        <h6><a href="mailto:marketing@sensiple.com">Marketing@sensiple.com</a></h6>
                    </div>
                </div>
            </div> --}}
            <div class=" footer-bottom">
                <div class="copyright-area">
                    <p>Copyright 2024 <a href="#">Sensiple</a></p>
                </div>
