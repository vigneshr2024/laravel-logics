...
@section('content')
    @if ($defaultCaseStudy)
        ...
        <div class="case-study-details-page pt-120 mb-120" id="case-details-section">
            <div class="container">
                <div class="row g-lg-4 gy-5 mb-80 ">
                    <div class="col-lg-8">
                        <div class="case-thumb">
                            <img src="{{ asset($defaultCaseStudy->banner_image) }}" alt=""
                                style="display: block;
                                margin-left: auto;
                                margin-right: auto;
                                width: 500%">
                            ...
                            <div class="case-info-wrap mb-40">
                                ...
                                <ul class="case-info">
                                    <li>
                                        ...
                                        <div class="content">
                                            <span>Category:</span>
                                            @foreach ($defaultCaseStudy->categories as $category)
                                                <h5>{{ $category->name }}</h5>
                                            @endforeach
                                            {{-- <h5>Software</h5> --}}
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <span>Location:</span>
                                            <h5>{{ $defaultCaseStudy->location }}</h5>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon">
                                        ...
                                        <div class="content">
                                            <span>Industry:</span>
                                            @foreach ($defaultCaseStudy->industries as $industry)
                                                <h5>{{ $industry->name }}</h5>
                                            @endforeach
                                            {{-- <h5>IT & Consulting</h5> --}}
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <span>Stack:</span>
                                            @foreach ($defaultCaseStudy->stacks as $stack)
                                                <h5>{{ $stack->name }}</h5>
                                            @endforeach
